...
import { Edit, Trash2, Plus, Search, Layers, FileText, ArrowLeft } from 'lucide-react';
  ...
  const descBodyTemplate = (rowData) => {
      return (
          <span className="text-gray-500 text-sm line-clamp-2">
              {rowData.description || <span className="text-gray-300 italic">Không có mô tả</span>}
          </span>
      )
  }
  ...
  const emptyTemplate = () => (
    <div className="flex flex-col items-center justify-center p-12 text-center">
      ...
      <p className="text-gray-500 text-sm max-w-sm">
        Chưa có danh mục tin tức nào trong danh sách. Hãy thêm danh mục mới để phân loại nội dung biểu đạt.
      </p>
    </div>
  );
    ...
    <div className="p-4 sm:p-6 lg:p-8 bg-[#faf7f2] min-h-full">
      ...
      <div className="max-w-[1200px] mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Danh Mục Tin Tức</h1>
            <p className="text-sm text-gray-500 mt-1">Phân loại và quản lý các chuyên mục bài viết.</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 relative custom-p-table">
          ...
          <DataTable
            ...
            rowHover
          >
            <Column field="article_category_id" header="ID" width="100px" sortable />
            <Column field="category_name" header="Tên Danh Mục" body={nameBodyTemplate} sortable />
            <Column field="slug" header="Slug / Đường dẫn" body={slugBodyTemplate} sortable />
            <Column field="description" header="Mô Tả Danh Mục" body={descBodyTemplate} />
            <Column header="Thao Tác" body={actionBodyTemplate} align="right" width="140px" />
          </DataTable>
        </div>
